...
OO.ui.mixin.ClippableElement.prototype.setClippableElement = function ( $clippable ) {
	var existingState = this.$clippable ? this.$clippable.getClippableState() : {};

	if ( this.$clippable ) {
		this.$clippable.destroyClippable();
	...
	this.$clippable.clippable( existingState );
};
...
OO.ui.mixin.ClippableElement.prototype.setClippableContainer = function ( $clippableContainer ) {
	this.$clippable.clippable( {
		$clippableContainer: $clippableContainer
	} );
};
...
OO.ui.mixin.ClippableElement.prototype.isClipping = function () {
	return this.$clippable.getClippableState( 'clipping' );
};
...
OO.ui.mixin.ClippableElement.prototype.isClipped = function () {
	return this.$clippable.getClippableState( 'clippedHorizontally' ) ||
		this.$clippable.getClippableState( 'clippedVertically' );
};
...
OO.ui.mixin.ClippableElement.prototype.isClippedVertically = function () {
	return this.$clippable.getClippableState( 'clippedVertically' );
};
